    ...
    <>
      ...
      <div className="max-w-3xl mx-auto bg-app-surface p-8 rounded-lg shadow-lg border border-app-default">
        <div className="prose prose-lg max-w-none">
            <h1 className="text-3xl sm:text-4xl font-bold mb-6 text-center text-app-main">Kebijakan Privasi</h1>
            
            <p className="text-sm text-app-muted text-center">Terakhir diperbarui: 26 Oktober 2023</p>
