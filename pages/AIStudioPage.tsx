    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg space-y-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">1. Upload an Image</label>
            <input
              id="file-upload"
              type="file"
            ...
            {imagePreview ? (
              <div className="relative group">
                <img src={imagePreview} alt="Upload preview" className="w-full rounded-md shadow-inner" />
              ...
              <label htmlFor="file-upload" className="flex justify-center w-full h-48 px-4 transition bg-white border-2 border-gray-300 border-dashed rounded-md appearance-none cursor-pointer hover:border-secondary focus:outline-none">
          ...
          <button
            ...
            className="w-full inline-flex justify-center py-3 px-6 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-secondary hover:bg-secondary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
          >
        ...
        {/* Output Column */}
        <div className="bg-white p-6 rounded-lg shadow-lg flex items-center justify-center min-h-[400px]">
          {isLoading ? (
            <div className="text-center">
              ...
              <p className="text-gray-600">Generating your image, please wait...</p>
            </div>
          ) : error ? (
